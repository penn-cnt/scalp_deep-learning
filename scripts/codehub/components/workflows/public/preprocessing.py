...
class mne_processing:
    ...
    def eyeblink_removal(self,low_pass,high_pass,config_path,n_components=None,max_iter=5000):
        """
        ...
        raw = raw.filter(low_pass,high_pass,verbose=False)
                ...
                if hasattr(cls,method_name):
                    ...
                    if cls.__name__ not in ['preprocessing_utils','mne_processing']:
                        ...
                        try:
                            ...
                            if self.args.debug:
                                print(f"MNE Error {e}")
                                print(self.metadata[self.file_cntr]['file'])
