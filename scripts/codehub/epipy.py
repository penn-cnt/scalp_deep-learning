...
def argument_handler(argument_dir='./',require_flag=True):
    ...
    misc_group.add_argument("--nfreq_window", type=int, default=2, help="Optional. Minimum number of samples required to send to preprocessing and feature extraction.")
